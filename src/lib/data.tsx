...
export const BANNER_CONTENT = {
    EN: {
        ...
        description: (
            <>
                Hi! I& apos; m{' '}
                <span className="font-medium text-foreground" > Murat </span>. A
                creative Frontend Developer with 3 + years of experience in
    ...
    TR: {
        ...
        description: (
            <>
                Merhaba! Ben{' '}
                <span className="font-medium text-foreground" > Murat </span>.
                Yüksek performanslı, ölçeklenebilir ve duyarlı web çözümleri
                oluşturma konusunda 3 + yıllık deneyime sahip yaratıcı bir
                Frontend Geliştiricisiyim.
            </>
        ),
        button: 'Benimle Çalış',
        stats: {
