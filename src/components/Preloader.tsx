...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
            <div className="preloader-item h-full w-[10%] bg-preloader"></div>
            <div className="preloader-item h-full w-[10%] bg-preloader"></div>
            <div className="preloader-item h-full w-[10%] bg-preloader"></div>
            <div className="preloader-item h-full w-[10%] bg-preloader"></div>
            <div className="preloader-item h-full w-[10%] bg-preloader"></div>
            ...
            <div className="name-text absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center font-anton text-[15vw] lg:text-[120px] leading-relaxed tracking-[0.05em] text-center z-10 text-white dark:text-foreground">
